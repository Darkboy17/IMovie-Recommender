...
@service.json
def get_recommendations(watched_movies, num_movies):
    print("No of recommended movies selected: ", num_movies); 
    ...
    print("Total Recommended Movies: ",len(recommended_movies));   

    if len(recommended_movies) > 500:
        recommended_movies = recommended_movies[0:num_movies]
